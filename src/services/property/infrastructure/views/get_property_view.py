...
from services.property.aplication import GetProperty
from services.property.schemas import get_property_schema


class GetPropertyAPIView(generics.RetrieveAPIView):
    """
    API view to `retrieve a property` based on its primary key (pk).\n
    This view handles GET requests and returns the property details in JSON format.
    """
